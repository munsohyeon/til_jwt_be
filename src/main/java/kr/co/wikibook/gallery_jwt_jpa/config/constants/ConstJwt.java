package kr.co.wikibook.gallery_jwt_jpa.config.constants;
...
public class ConstJwt {
    ...
    private final int accessTokenCookieValidityMilliseconds;

    private final String refreshTokenCookieName;
    private final String refreshTokenCookiePath;
    private final int refreshTokenCookieValiditySeconds;
    private final int refreshTokenCookieValidityMilliseconds;
}
