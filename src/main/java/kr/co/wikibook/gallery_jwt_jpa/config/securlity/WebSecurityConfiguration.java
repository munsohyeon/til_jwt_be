...
public class WebSecurityConfiguration {
    ...
    //Bean 메소드
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, TokenAuthenticationFilter tokenAuthenticationFilter, TokenAuthenticationEntryPoint tokenAuthenticationEntryPoint, CorsConfigurationSource corsConfigurationSource) throws Exception{
        //람다식
