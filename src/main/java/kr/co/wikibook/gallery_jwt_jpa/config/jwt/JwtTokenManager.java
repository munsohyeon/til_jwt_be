...
import kr.co.wikibook.gallery_jwt_jpa.config.util.CookieUtils;
...
public class JwtTokenManager {
    ...
    public String generateAccessToken(JwtUser jwtUser) {
        return jwtTokenProvider.generateToken(jwtUser, constJwt.getAccessTokenCookieValidityMilliseconds());
    }
